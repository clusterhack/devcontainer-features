# Generated by Powerlevel10k configuration wizard on 2024-04-08 at 01:05 EDT.
...
() {
  ...
  typeset -g POWERLEVEL9K_TRANSIENT_PROMPT=off  # We manage this manually, so we can customize
